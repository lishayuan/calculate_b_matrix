...
%% Part I: let's do the calculation for the 2nd ~ the end segment 
% (for y-axis calculation, it will be an expression of accumStartFy)
...
%% Part II: let's do the calculation for the first segment
